...
from mapFolding.theSSOT import getAlgorithmDispatcher, getAlgorithmSource, getPackageDispatcher, listNumbaCallableDispatchees, moduleOfSyntheticModulesPACKAGING, FREAKOUT
