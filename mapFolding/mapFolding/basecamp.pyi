...
from mapFolding import computationState as computationState, getDispatcherCallable as getDispatcherCallable, getPathFilenameFoldsTotal as getPathFilenameFoldsTotal, outfitCountFolds as outfitCountFolds, saveFoldsTotal as saveFoldsTotal
from os import PathLike

def countFolds(listDimensions: Sequence[int], pathLikeWriteFoldsTotal: str | PathLike[str] | None = None, computationDivisions: int | str | None = None, CPUlimit: int | float | bool | None = None, **keywordArguments: str | bool) -> int:
