import ast
import types
from mapFolding import FREAKOUT as FREAKOUT, ParametersNumba as ParametersNumba, ParametersSynthesizeNumbaCallable as ParametersSynthesizeNumbaCallable, Z0Z_filenameModuleWrite as Z0Z_filenameModuleWrite, Z0Z_filenameWriteElseCallableTarget as Z0Z_filenameWriteElseCallableTarget, Z0Z_formatFilenameModuleSynthetic as Z0Z_formatFilenameModuleSynthetic, additional_importsHARDCODED as additional_importsHARDCODED, getAlgorithmDispatcher as getAlgorithmDispatcher, getAlgorithmSource as getAlgorithmSource, getDatatypeModule as getDatatypeModule, listNumbaCallableDispatchees as listNumbaCallableDispatchees, moduleOfSyntheticModulesPACKAGING as moduleOfSyntheticModulesPACKAGING, parametersNumbaDEFAULT as parametersNumbaDEFAULT, parametersNumbaSuperJit as parametersNumbaSuperJit, parametersNumbaSuperJitParallel as parametersNumbaSuperJitParallel, pathPackage as pathPackage
from mapFolding.someAssemblyRequired import FunctionInliner as FunctionInliner, UniversalImportTracker as UniversalImportTracker, YouOughtaKnow as YouOughtaKnow, ast_Identifier as ast_Identifier, decorateCallableWithNumba as decorateCallableWithNumba
from os import PathLike
from typing import Any, overload

def makeFunctionDef(astModule: ast.Module, callableTarget: str, parametersNumba: ParametersNumba | None = None, inlineCallables: bool | None = False, allImports: UniversalImportTracker | None = None) -> tuple[ast.FunctionDef, UniversalImportTracker]: ...
