from mapFolding.daoOfMapFolding import (
	activeLeafGreaterThan0, activeLeafGreaterThanLeavesTotal, activeLeafIsTheFirstLeaf,
	activeLeafIsUnconstrainedInAllDimensions, activeLeafUnconstrainedInThisDimension, filterCommonGaps, gapAvailable,
	incrementIndexMiniGap, initializeIndexMiniGap, initializeVariablesToFindGaps, insertActiveLeaf, insertActiveLeafAtGap,
	leafBelowSentinelIs1, leafConnecteeIsActiveLeaf, lookForGaps, lookupLeafConnecteeInConnectionGraph,
	loopingLeavesConnectedToActiveLeaf, loopingThroughTheDimensions, loopingToActiveGapCeiling, noGapsHere,
	tryAnotherLeafConnectee, tryNextDimension, undoLastLeafPlacement)
from mapFolding.dataBaskets import MapFoldingState

# NOTE very interesting
# incrementActiveGap,
# incrementGap1ndexCeiling,
