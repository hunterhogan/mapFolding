...
def A000682(
    ...
    if n in {1, 2}:
        ...
        countTotal = A223093(n - 1) + (1 + (n & 0b1)) * _A005316(n - 1)
...
def A005316(
    ...
    if n in {0, 1}:
        ...
        countTotal = (_A000682(n + 1) - A223093(n)) // (2 - (n & 0b1))
    elif f == 'A077014':
...
def A077460(
    n: int
    , f: str
    | Literal['A005315, A005316, and A060206', 'A005316, A005315, and A060206', 'A000682 and A005316'] = 'A005315, A005316, and A060206'
) -> int:
