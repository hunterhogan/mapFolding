...
These functions have matured, and I'll probably be using them for the foreseeable future. But their style diverges from the rest of the codebase, and I wish they were more consistent with it. They are not dry: I copy-paste the code from one module to another.
...
I very much like Fira Code and there might be other fonts I would like. I haven't looked because Fira Code is great. But Fira Code doesn't seem to have the CJK code points I need, so I currently have two monospaced fonts with different widths. I just want the same width for everything. Maybe I could change the pitch/CPI of the CJK font to match Fira Code?

## Ruff

In general, I love it. But I need to have different "levels" of strictness for different files. When I am developing a file or function, I don't want diagnostics about commented out code or print or a bunch of other things.
