...
domainsOfDimensionOrigins = tuple(getDomainLeaf(state, leaf) for leaf in state.productsOfDimensions)[0:-1]
...
#======== By exclusion of the indices, add non-consecutive piles (54 pairs) ====================
	...
	for 次Domain零, pileOfLeaf零 in enumerate(filter(between吗(pileOrigin, 首零(dimensionsTotal) - 零), domain零)):
