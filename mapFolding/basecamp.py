...
Functions
    ...
    countingMeanders
        You can compute OEIS sequences related to meanders [2], symmetric foldings, and formula-based
        sequences.
...
Algorithm Version Selection
    ...
    generation toolchain. The `countingMeanders` function serves as a catch-all for OEIS sequences
    that use specialized algorithms (meanders, symmetric foldings) or closed-form formulas. Future
    development will add `eliminateFolds` as a stable interface for the experimental elimination-based
    algorithms.
