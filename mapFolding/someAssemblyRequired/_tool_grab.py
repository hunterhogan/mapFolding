...
class grab:
    ...
    @staticmethod
    def annotationAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTannotation], hasDOTannotation]:
    ...
    @staticmethod
    def argAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTarg], hasDOTarg]:
    ...
    @staticmethod
    def argsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTargs], hasDOTargs]:
    ...
    @staticmethod
    def argtypesAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTargtypes], hasDOTargtypes]:
    ...
    @staticmethod
    def asnameAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTasname], hasDOTasname]:
    ...
    @staticmethod
    def attrAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTattr], hasDOTattr]:
    ...
    @staticmethod
    def basesAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTbases], hasDOTbases]:
    ...
    @staticmethod
    def bodyAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTbody], hasDOTbody]:
    ...
    @staticmethod
    def boundAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTbound], hasDOTbound]:
    ...
    @staticmethod
    def casesAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTcases], hasDOTcases]:
    ...
    @staticmethod
    def causeAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTcause], hasDOTcause]:
    ...
    @staticmethod
    def clsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTcls], hasDOTcls]:
    ...
    @staticmethod
    def comparatorsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTcomparators], hasDOTcomparators]:
    ...
    @staticmethod
    def context_exprAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTcontext_expr], hasDOTcontext_expr]:
    ...
    @staticmethod
    def conversionAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTconversion], hasDOTconversion]:
    ...
    @staticmethod
    def ctxAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTctx], hasDOTctx]:
    ...
    @staticmethod
    def decorator_listAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTdecorator_list], hasDOTdecorator_list]:
    ...
    @staticmethod
    def default_valueAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTdefault_value], hasDOTdefault_value]:
    ...
    @staticmethod
    def defaultsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTdefaults], hasDOTdefaults]:
    ...
    @staticmethod
    def eltAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTelt], hasDOTelt]:
    ...
    @staticmethod
    def eltsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTelts], hasDOTelts]:
    ...
    @staticmethod
    def excAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTexc], hasDOTexc]:
    ...
    @staticmethod
    def finalbodyAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTfinalbody], hasDOTfinalbody]:
    ...
    @staticmethod
    def format_specAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTformat_spec], hasDOTformat_spec]:
    ...
    @staticmethod
    def funcAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTfunc], hasDOTfunc]:
    ...
    @staticmethod
    def generatorsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTgenerators], hasDOTgenerators]:
    ...
    @staticmethod
    def guardAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTguard], hasDOTguard]:
    ...
    @staticmethod
    def handlersAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOThandlers], hasDOThandlers]:
    ...
    @staticmethod
    def idAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTid], hasDOTid]:
    ...
    @staticmethod
    def ifsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTifs], hasDOTifs]:
    ...
    @staticmethod
    def is_asyncAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTis_async], hasDOTis_async]:
    ...
    @staticmethod
    def itemsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTitems], hasDOTitems]:
    ...
    @staticmethod
    def iterAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTiter], hasDOTiter]:
    ...
    @staticmethod
    def keyAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTkey], hasDOTkey]:
    ...
    @staticmethod
    def keysAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTkeys], hasDOTkeys]:
    ...
    @staticmethod
    def keywordsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTkeywords], hasDOTkeywords]:
    ...
    @staticmethod
    def kindAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTkind], hasDOTkind]:
    ...
    @staticmethod
    def kw_defaultsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTkw_defaults], hasDOTkw_defaults]:
    ...
    @staticmethod
    def kwargAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTkwarg], hasDOTkwarg]:
    ...
    @staticmethod
    def kwd_attrsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTkwd_attrs], hasDOTkwd_attrs]:
    ...
    @staticmethod
    def kwd_patternsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTkwd_patterns], hasDOTkwd_patterns]:
    ...
    @staticmethod
    def kwonlyargsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTkwonlyargs], hasDOTkwonlyargs]:
    ...
    @staticmethod
    def leftAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTleft], hasDOTleft]:
    ...
    @staticmethod
    def levelAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTlevel], hasDOTlevel]:
    ...
    @staticmethod
    def linenoAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTlineno], hasDOTlineno]:
    ...
    @staticmethod
    def lowerAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTlower], hasDOTlower]:
    ...
    @staticmethod
    def moduleAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTmodule], hasDOTmodule]:
    ...
    @staticmethod
    def msgAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTmsg], hasDOTmsg]:
    ...
    @staticmethod
    def nameAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTname], hasDOTname]:
    ...
    @staticmethod
    def namesAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTnames], hasDOTnames]:
    ...
    @staticmethod
    def opAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTop], hasDOTop]:
    ...
    @staticmethod
    def operandAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOToperand], hasDOToperand]:
    ...
    @staticmethod
    def opsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTops], hasDOTops]:
    ...
    @staticmethod
    def optional_varsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOToptional_vars], hasDOToptional_vars]:
    ...
    @staticmethod
    def orelseAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTorelse], hasDOTorelse]:
    ...
    @staticmethod
    def patternAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTpattern], hasDOTpattern]:
    ...
    @staticmethod
    def patternsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTpatterns], hasDOTpatterns]:
    ...
    @staticmethod
    def posonlyargsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTposonlyargs], hasDOTposonlyargs]:
    ...
    @staticmethod
    def restAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTrest], hasDOTrest]:
    ...
    @staticmethod
    def returnsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTreturns], hasDOTreturns]:
    ...
    @staticmethod
    def rightAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTright], hasDOTright]:
    ...
    @staticmethod
    def simpleAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTsimple], hasDOTsimple]:
    ...
    @staticmethod
    def sliceAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTslice], hasDOTslice]:
    ...
    @staticmethod
    def stepAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTstep], hasDOTstep]:
    ...
    @staticmethod
    def subjectAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTsubject], hasDOTsubject]:
    ...
    @staticmethod
    def tagAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTtag], hasDOTtag]:
    ...
    @staticmethod
    def targetAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTtarget], hasDOTtarget]:
    ...
    @staticmethod
    def targetsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTtargets], hasDOTtargets]:
    ...
    @staticmethod
    def testAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTtest], hasDOTtest]:
    ...
    @staticmethod
    def typeAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTtype], hasDOTtype]:
    ...
    @staticmethod
    def type_commentAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTtype_comment], hasDOTtype_comment]:
    ...
    @staticmethod
    def type_ignoresAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTtype_ignores], hasDOTtype_ignores]:
    ...
    @staticmethod
    def type_paramsAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTtype_params], hasDOTtype_params]:
    ...
    @staticmethod
    def upperAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTupper], hasDOTupper]:
    ...
    @staticmethod
    def valuesAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTvalues], hasDOTvalues]:
    ...
    @staticmethod
    def varargAttribute(action: Callable[[Any], Any]) -> Callable[[hasDOTvararg], hasDOTvararg]:
